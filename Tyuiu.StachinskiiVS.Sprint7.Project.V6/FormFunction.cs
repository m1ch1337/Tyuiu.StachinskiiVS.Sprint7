    ...
    public partial class FormFunction : Form
    {
        ...
        private void столбецДиагнозToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (columns > columnD)
            {
                ...
                chartFunction_SVS.Series.Clear();
                Series series = new Series("Диагноз");
                series.ChartType = SeriesChartType.Column;
                series.Color = Color.DarkSlateGray;
                this.chartFunction_SVS.ChartAreas[0].AxisX.Title = "Диагноз";
                this.chartFunction_SVS.ChartAreas[0].AxisY.Title = "Количесвто";
                chartFunction_SVS.ChartAreas[0].AxisX.TitleFont = new Font("Microsoft Sans Serif", 12, FontStyle.Bold);
                chartFunction_SVS.ChartAreas[0].AxisY.TitleFont = new Font("Microsoft Sans Serif", 12, FontStyle.Bold);
                foreach (var i in count)
                {
                    series.Points.AddXY(i.Key, i.Value);
                }
                chartFunction_SVS.Series.Add(series);
                chartFunction_SVS.Update();
            }
        }
        ...
        private void столбецToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (columns > columnD)
            {
                ...
                series.ChartType = SeriesChartType.Column;
                series.Color = Color.DarkSlateGray;
                this.chartFunction_SVS.ChartAreas[0].AxisX.Title = "Диспансерный учёт";
                this.chartFunction_SVS.ChartAreas[0].AxisY.Title = "Количесвто";
                chartFunction_SVS.ChartAreas[0].AxisX.TitleFont = new Font("Microsoft Sans Serif", 12, FontStyle.Bold);
                chartFunction_SVS.ChartAreas[0].AxisY.TitleFont = new Font("Microsoft Sans Serif", 12, FontStyle.Bold);
                foreach (var i in count)
        ...
        private void амбулаторноеЛечениеToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (columns > columnD)
            {
                ...
                series.ChartType = SeriesChartType.Column;
                series.Color = Color.DarkSlateGray;
                this.chartFunction_SVS.ChartAreas[0].AxisX.Title = "Амбулаторное лечение";
                this.chartFunction_SVS.ChartAreas[0].AxisY.Title = "Количесвто";
                chartFunction_SVS.ChartAreas[0].AxisX.TitleFont = new Font("Microsoft Sans Serif", 12, FontStyle.Bold);
                chartFunction_SVS.ChartAreas[0].AxisY.TitleFont = new Font("Microsoft Sans Serif", 12, FontStyle.Bold);
                foreach (var i in count)
        ...
        private void должностьВрачаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (columns > columnD)
            {
                ...
                series.ChartType = SeriesChartType.Column;
                series.Color = Color.DarkSlateGray;
                this.chartFunction_SVS.ChartAreas[0].AxisX.Title = "Должность варча";
                this.chartFunction_SVS.ChartAreas[0].AxisY.Title = "Количесвто";
                chartFunction_SVS.ChartAreas[0].AxisX.TitleFont = new Font("Microsoft Sans Serif", 12, FontStyle.Bold);
                chartFunction_SVS.ChartAreas[0].AxisY.TitleFont = new Font("Microsoft Sans Serif", 12, FontStyle.Bold);
                foreach (var i in count)
        ...
        private void buttonBack_SVS_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        private void buttonSaveGraph_SVS_Click(object sender, EventArgs e)
        {
            string saveCh = Environment.CurrentDirectory + "\\chartFunction_SVS.png";
            chartFunction_SVS.SaveImage(saveCh, ChartImageFormat.Png);
