...
namespace Tyuiu.StachinskiiVS.Sprint7.Project.V6.Test
{
    [TestClass]
    public class DataServiceTest
    {
        ...
        public void CheckFile()
        {
            ...
            string path = @"C:\stach\Tyuiu.StachinskiiVS.Sprint7\Tyuiu.StachinskiiVS.Sprint7.Project.V6\bin\Debug\Информация о пациентах";
